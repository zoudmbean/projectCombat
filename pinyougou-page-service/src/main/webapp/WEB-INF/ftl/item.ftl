						...
						<div id="specification" class="summary-wrap clearfix">
							<#list specificationList as item>
								<dl>
									...
									-->
									<#list item.attributeValue as attr>
										<dd><a href="javascript:void(0);" class="{{specIsSelected('${item.attributeName}','${attr}')?'selected':''}}" ng-click="selectSpecs('${item.attributeName}','${attr}')">${attr}<span title="点击取消选择">&nbsp;</span></a></dd>
									</#list>
								</dl>
							</#list>
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<#if (customAttributeList?size>0)> <#-- list大于0才循环 -->
										<#list customAttributeList as item>
											<#if item.value??> <#-- 变量值存在才显示 -->
