<template>
  <div style="width: 100%;height: 100%;">
    <el-row :gutter="20">
      <el-col :span="6" style="border-right: 2px solid #6f7180;">
...
<script>
  ...
  export default {
    ...
    mounted() {
      // 订阅消息
      PubSub.subscribe('nodeClick',(msg,{data,node,component}) => {
        // console.log(msg,data,node,component);
        this.nodeClick({data,node,component});
      });
    },
    methods: {
      // category组件方法
